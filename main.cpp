...
int main() {
    ...
    bitboard_t black_pieces = bitboard_t(std::string("0000000000000000100000000000000000000000000000001111111111111111"));
    ...
    WhitePawns.pushPawns(white_pieces, black_pieces);
